...
export default function SecondaryNavigation() {
  ...
  return (
    <nav className="flex justify-between items-center py-6 px-6 sm:px-20 w-full max-w-8xl mx-auto">
      <div className="text-2xl font-bold text-energy-green">CircuitPath</div>
      ...
      <div className="hidden md:flex space-x-8 items-center">
        ...
        <div className="relative" ref={servicesRef}>
          <button 
            ...
            className="text-[#3c3c3c] hover:text-secondary transition-colors flex items-center"
          >
            Services
        ...
        <Link href="/contact" className="text-[#3c3c3c] hover:text-secondary transition-colors">Contact</Link>
      </div>
